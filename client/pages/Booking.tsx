              ...
              <Form {...form}>
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="uppercase tracking-widest text-xs font-semibold">
                          Услуга
                        </FormLabel>
                        <Select
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              type="date"
                              className="bg-background rounded-xl py-6"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                  ...
                  <Button
                    type="submit"
                    className="w-full rounded-full py-8 uppercase tracking-widest text-sm shadow-xl hover:shadow-primary/20 transition-all"
                  >
                    Отправить заявку
                  </Button>
                </form>
            ...
            >
              <div className="bg-primary/5 p-8 rounded-3xl border border-primary/10">
                ...
                <p className="text-sm text-muted-foreground mb-8">
                  Если у вас остались вопросы, напишите нам в мессенджеры — мы
                ...
                <div className="space-y-4">
                  <Button
                    asChild
                    variant="outline"
                    className="w-full rounded-xl py-6 border-primary/20 text-primary hover:bg-primary/10 justify-start gap-4"
                  >
                    <a
                      href="https://wa.me/79231351711"
                      target="_blank"
              ...
              <div className="bg-card p-8 rounded-3xl border border-border/20">
                ...
                <p className="text-sm font-semibold">07:00 – 22:00 ежедневно</p>
              </div>
            </motion.div>
          </div>
        </div>
