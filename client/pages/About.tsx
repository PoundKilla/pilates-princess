      ...
      <div className="pt-32 pb-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
            ...
            >
              <h1 className="text-4xl md:text-7xl font-serif mb-12">
                О студии
              </h1>
              <p className="text-2xl font-serif text-primary leading-relaxed mb-8">
                Pilates Princess — это luxury-студия пилатеса для женщин, где
                каждая тренировка — это путь к гармонии тела и внутреннего
                состояния.
              </p>
              <p className="text-lg text-muted-foreground leading-loose">
                Мы создали пространство, где эстетика встречается с
                профессионализмом. Наши студии расположены в самом центре города
                и оборудованы по последнему слову техники для того, чтобы вы
                могли наслаждаться каждым движением.
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <h3 className="text-xl font-serif mb-4 text-primary uppercase tracking-widest text-sm font-semibold">
                Контакты
              </h3>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Красный проспект, 182, офис 422, 4 этаж
                  </p>
                </div>
                <div>
                  <p className="font-semibold mb-2">ДЦ Европа</p>
                  <p className="text-muted-foreground">
                    Красный проспект, 182/1, офис 909, 1116, 9 и 11 этаж
                  </p>
                </div>
                <a
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white">
                ...
                <p className="mt-2 text-white/80 uppercase tracking-widest text-xs">
                  Открыть 2ГИС
                </p>
              </div>
            </a>
